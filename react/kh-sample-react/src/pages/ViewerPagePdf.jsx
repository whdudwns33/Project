...
export const ViewerPagePdf = () => {
  const fileUrl =
    "https://firebasestorage.googleapis.com/v0/b/reactminiproject-15ad8.appspot.com/o/pdf_example.pdf?alt=media&token=30f08552-af58-4157-a364-f2e87f01f3d9";

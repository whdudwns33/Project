...
import { RightInfo, InputBox, SetButton, CloseButton,
    InputTag,  } from "./MyPageComp";
  ...
  return (
    <div>
        <RightInfo>
            ...
            {checkedInfo && (
              <InputTag>
                <InputBox placeholder="ID" type="text" onChange={onModifyId} />
                <div>{msg}</div>
                <div>
                  {checkTrue && (
                    <SetButton onClick={onClickModifyId}>제출</SetButton>
                  )}
